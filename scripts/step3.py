"""Step 3: add main() function definition"""
import os
...
def main():
    ...
    tokenizer_local = AutoTokenizer.from_pretrained("BAAI/bge-m3", cache_dir=MODEL_CACHE)
    model_local = AutoModel.from_pretrained("BAAI/bge-m3", cache_dir=MODEL_CACHE)
    print("[+] Model ready")
