...
## 输入假设
- 地块输入：{'address': '海棠区南田路16号', 'lng': 109.71899, 'lat': 18.4104, 'district': None, 'vision': '低密商墅项目'}
- 客户目标：{'product_type': '改善产品', 'benchmark': None, 'expected_price': 35000.0, 'floor_area_ratio': 1.2, 'year': 2026}
...
- 拿地敏感区间：{'conservative': 9005.0, 'balanced': 10613.0, 'aggressive': 12221.0, 'unit': '元/㎡土地口径粗算'}
...
```json
{
  "role": "蓝图与风险 Agent",
  "scenario_prices": {
    "conservative_sale_price": 26800.0,
    "base_sale_price": 26800.0,
    "benchmark_discount_sale_price": null
  },
  "land_value_sensitivity": {
    "conservative_land_value": 9005.0,
    "balanced_land_value": 10613.0,
    "aggressive_land_value": 12221.0,
    "unit": "元/㎡土地口径粗算",
  ...
  "absorption_simulation": {
    "total_units": 500,
    "sellout_months": 12.4,
    "monthly_absorption_rate_units": 40.2,
    "price_to_wtp_ratio": 0.89,
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-28T02:45:38",
    "target_year": 2026,
