...
## 输入假设
- 地块输入：{'city': '三亚', 'district': None, 'address': '三亚海棠区南田路16号', 'lng': None, 'lat': None, 'radius_km': 5.0, 'expected_price': 35000.0, 'price_band': 0.15}
- 客户目标：{'floor_area_ratio': 1.2, 'product_type': '商墅', 'benchmark': '保利棠隐'}
...
- 拿地敏感区间：{'conservative': 11999.0, 'balanced': 14142.0, 'aggressive': 16285.0, 'unit': '元/㎡土地口径粗算'}
- 核心机会：客户目标产品为商墅，应优先验证低密、私密性、到达仪式感和景观资源是否能支撑溢价。
...
```json
{
  ...
  "scenario_prices": {
    ...
    "base_sale_price": 35712.0,
    "benchmark_discount_sale_price": null
  },
  "land_value_sensitivity": {
    "conservative_land_value": 11999.0,
    "balanced_land_value": 14142.0,
    "aggressive_land_value": 16285.0,
    "unit": "元/㎡土地口径粗算",
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-12T18:26:09",
  ...
  "location": {
    ...
    "lat": 18.39598,
    "source": "amap_geocode",
    "formatted_addr": "海南省三亚市海棠区南田路16号",
    "level": "门址",
    "adcode": "460202"
  },
  "evidence_counts": {
