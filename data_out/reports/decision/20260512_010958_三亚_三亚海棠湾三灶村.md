...
## 输入假设
- 地块输入：{'city': '三亚', 'district': '帮我分析三亚海棠湾', 'address': '三亚海棠湾三灶村', 'lng': None, 'lat': None, 'radius_km': 5.0, 'expected_price': None, 'price_band': 0.15}
- 客户目标：{'floor_area_ratio': 1.2, 'product_type': '商墅', 'benchmark': '保利棠隐', 'asks_land_price': True}
...
```json
{
  ...
  "opportunities": [
    ...
    "客户目标产品为商墅，应优先验证低密、私密性、到达仪式感和景观资源是否能支撑溢价。"
  ],
  "product_reference": {
...
{
  "role": "任务书制定 Agent",
  "product_positioning": "以商墅为方向，先验证低密/私密/景观/康养服务是否真实支撑高端溢价。",
  "target_price_band": {
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-12T01:09:58",
