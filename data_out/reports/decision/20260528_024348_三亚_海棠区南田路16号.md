...
- 拿地敏感区间：{'conservative': 23712.0, 'balanced': 27947.0, 'aggressive': 32181.0, 'unit': '元/㎡土地口径粗算'}
- 核心机会：客户目标产品为低密商墅，应优先验证低密、私密性、到达仪式感和景观资源是否能支撑溢价。
- 硬性阻断：['缺少容积率假设，无法形成楼面口径敏感区间。', '需确认用地性质是否允许商墅/低密产品', '需确认可售分割、产权年限和商办/住宅监管口径']
...
```json
{
  ...
  "land_value_sensitivity": {
    "conservative_land_value": 23712.0,
    "balanced_land_value": 27947.0,
    "aggressive_land_value": 32181.0,
    "unit": "元/㎡土地口径粗算",
