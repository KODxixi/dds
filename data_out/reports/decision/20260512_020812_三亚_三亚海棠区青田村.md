...
- 客户目标：{'product_type': '住宅开发', 'asks_land_price': True}
...
- 拿地敏感区间：{'conservative': 16450.0, 'balanced': 19388.0, 'aggressive': 22325.0, 'unit': '元/㎡土地口径粗算'}
- 核心机会：客户目标产品为住宅开发，应优先验证低密、私密性、到达仪式感和景观资源是否能支撑溢价。
...
```json
{
  ...
  "opportunities": [
    "客户目标产品为住宅开发，应优先验证低密、私密性、到达仪式感和景观资源是否能支撑溢价。"
  ],
  "product_reference": {
...
{
  "role": "任务书制定 Agent",
  "product_positioning": "以住宅开发为方向，先验证低密/私密/景观/康养服务是否真实支撑高端溢价。",
  "target_price_band": {
...
```json
{
  ...
  "land_value_sensitivity": {
    "conservative_land_value": 16450.0,
    "balanced_land_value": 19388.0,
    "aggressive_land_value": 22325.0,
    "unit": "元/㎡土地口径粗算",
    "floor_area_ratio": 1.0,
    "floor_area_ratio_source": "dds_default_assumption"
  },
  "risk_curve": [
    {
      "risk": "政策风险",
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-12T02:08:12",
