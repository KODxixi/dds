...
## 输入假设
- 地块输入：{'address': '海棠区南田路16号', 'lng': 109.72162, 'lat': 18.397784, 'district': 'proxy', 'vision': None}
...
- 拿地敏感区间：{'conservative': 19505.0, 'balanced': 22988.0, 'aggressive': 26471.0, 'unit': '元/㎡土地口径粗算'}
...
```json
{
  ...
  "product_reference": {
    ...
    "observed_room_types": [
      ...
      "2室户型,3室户型,4室户型",
      "2室户型,3室户型,4室户型",
      "1室户型,2室户型,3室户型,4室户型,5室户型,9室户型,别墅户型",
      "3室户型",
      "2室户型,3室户型,4室户型",
      "3室户型,4室户型",
      "2室户型,3室户型",
...
```json
{
  "role": "蓝图与风险 Agent",
  "scenario_prices": {
    "conservative_sale_price": 30000.0,
    "base_sale_price": 34830.0,
    "benchmark_discount_sale_price": null
  },
  "land_value_sensitivity": {
    "conservative_land_value": 19505.0,
    "balanced_land_value": 22988.0,
    "aggressive_land_value": 26471.0,
    "unit": "元/㎡土地口径粗算",
  ...
  "absorption_simulation": {
    "total_units": 500,
    "sellout_months": 14.9,
    "monthly_absorption_rate_units": 33.5,
    "price_to_wtp_ratio": 1.16,
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-28T15:03:44",
    "target_year": 2026,
    "data_timestamp": "2026-05-27T11:26:11",
    "data_age_days": 1,
  ...
  "location": {},
  "evidence_counts": {
    "nearby_competitors": 51,
    "amenity_categories": 5
  },
  "trust_weights": {
    "level_1": 1.0,
    "level_2": 0.7,
