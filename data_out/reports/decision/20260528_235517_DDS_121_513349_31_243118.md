...
## 输入假设
- 地块输入：{'address': '121.513349,31.243118', 'lng': 109.177902, 'lat': 18.349327, 'district': 'proxy', 'vision': None}
...
- 拿地敏感区间：{'conservative': 11970.0, 'balanced': 14108.0, 'aggressive': 16245.0, 'unit': '元/㎡土地口径粗算'}
...
```json
{
  ...
  "product_reference": {
    ...
    "top_price_projects": [
      ...
      {
        "project_name": "三亚招商·臻园",
        "price": 24000.0,
        "area_range": "125-143㎡",
        "room_types": "3室户型,4室户型"
      },
      {
        "project_name": "金茂三亚天鹭满湾",
        "price": 23000.0,
        "area_range": "110-185㎡",
        "room_types": "3室户型,4室户型"
      }
...
```json
{
  "role": "蓝图与风险 Agent",
  "scenario_prices": {
    "conservative_sale_price": 21508.0,
    "base_sale_price": 21375.0,
    "benchmark_discount_sale_price": null
  },
  "land_value_sensitivity": {
    "conservative_land_value": 11970.0,
    "balanced_land_value": 14108.0,
    "aggressive_land_value": 16245.0,
    "unit": "元/㎡土地口径粗算",
  ...
  "absorption_simulation": {
    "total_units": 500,
    "sellout_months": 11.2,
    "monthly_absorption_rate_units": 44.7,
    "price_to_wtp_ratio": 0.71,
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-28T23:54:57",
    "target_year": 2026,
