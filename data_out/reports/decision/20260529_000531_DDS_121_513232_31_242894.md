...
## 输入假设
- 地块输入：{'address': '121.513232,31.242894', 'lng': 121.513232, 'lat': 31.242894, 'district': None, 'vision': None}
- 客户目标：{'product_type': '改善产品', 'benchmark': None, 'expected_price': None, 'floor_area_ratio': 2.0, 'year': 2023}
...
- 拿地敏感区间：{'conservative': 68542.0, 'balanced': 80782.0, 'aggressive': 93022.0, 'unit': '元/㎡土地口径粗算'}
    ...
    "top_price_projects": [
      {
        ...
        "price": 168000.0,
        "area_range": "144-578㎡",
        "room_types": "2室户型,3室户型,4室户型,5室户型,6室户型"
      },
      {
        "project_name": "景瑞尚滨江",
        "price": 145000.0,
      ...
      },
      {
        ...
        "price": 135000.0,
        "area_range": "90-400㎡",
        "room_types": "1室户型,2室户型,3室户型,4室户型,7室户型"
      }
    ]
  },
  "vector_evidence": {
...
```json
{
  "role": "蓝图与风险 Agent",
  "scenario_prices": {
    "conservative_sale_price": 119800.0,
    "base_sale_price": 122397.0,
    "benchmark_discount_sale_price": null
  },
  "land_value_sensitivity": {
    "conservative_land_value": 68542.0,
    "balanced_land_value": 80782.0,
    "aggressive_land_value": 93022.0,
    "unit": "元/㎡土地口径粗算",
...
{
  "parcel_report_meta": {
    "generated_at": "2026-05-29T00:04:59",
    "target_year": 2023,
