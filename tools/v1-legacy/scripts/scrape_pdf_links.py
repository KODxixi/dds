...
BASE_DIRS = {
    "landchina":    Path(r"D:\Vault-assets\AI_Projects\DDS\data_out\landchina\normalized"),
    "hangzhou":     Path(r"D:\Vault-assets\AI_Projects\DDS\data_out\hangzhou\normalized"),
    "sanya":        Path(r"D:\Vault-assets\AI_Projects\DDS\data_out\sanya\normalized"),
}

PDF_RAW_ROOT = Path(r"D:\Vault-assets\AI_Projects\DDS\data_out\pdfs\raw")
MANIFEST_ROOT = Path(r"D:\Vault-assets\AI_Projects\DDS\data_out\pdfs\manifests")
